# BFP [Brainf*ck plus]
## [!WARNING¡] I can't guarantee that the interpreter's logic is perfect, so there could be bugs within. Also I might forget to update something after changing it, though the code as of 2/4/2026 is prbly the final version I will publish myself [¡GNINRAW!]
