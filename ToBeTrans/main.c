...
int main(void){
	...
	print("[!WARNING¡] THIS GAME HAS 1 OUTCOME WITH A REFFRENCE TO SUICIDE, PROCEED AT YOUR OWN RISK [¡GNINRAW!]",-1);
	...
	print("You look at yourself and critique your bodily features.",SPEED);
	...
	printf("%d\n\n",a);
	if (a==1){
		print("You stare at yourself for about an hour, critiquing every little detail.",SPEED);
		...
		print("You wish you were more like them than the lazy child you are.",SPEED);
		...
		print("You have a really productive school day.",SPEED);
		...
		print("The school day is full of joy, but soon it comes to an end, and you are on the return bus home.",SPEED);
	}
	puts("");
	print(bc,0);
	printf("what is your choice: ");
	...
	if (b==1){
		if (a==1){
			...
			print("…invisible. Yeah, that’s the word.",SPEED);
			print("A sudden feeling creeps into your head and causes your chest to tighten.",SPEED);
			print("What if you were never there?",SPEED+750);
			...
			print("Watching people do what they love brings back happy memories from your own past.",SPEED);
			print("You almost feel like posting your own videos, but decide it’s not worth the hassle.",SPEED);
			print("Warmth spreads through your chest, and you feel better than this morning.",SPEED);
		...
		if (a==1){
			...
			print("They are all fit, and you can’t even get yourself to go to the gym.",SPEED);
			print("They are all smart, but you can never focus while trying to learn.",SPEED);
			...
			print("The world is bright and cheery today as you watch people wander through the busy streets.",SPEED);
			print("You see a young boy returning a wallet to a man and a lady helping an elderly couple carry their groceries.",SPEED);
			print("You can’t help but think of how the world is a beautiful place.",SPEED);
	...
	if (c==1){
		if (a==1){
			...
			print("Every single minor imperfection feels major in the moment, and you feel like you don’t have the will to continue this miserable life any longer.",SPEED);
			...
			print("\n*** BAD ENDING: “Hanging Out” ***",-1);
		} else {
			print("You look into the mirror and wonder what would happen if you acted how you wanted to.",SPEED);
			print("You strike a couple of poses and laugh as you do each one, full of joy and energy.",SPEED);
			print("You feel happy and alive, as if you were removing your mask and letting your soul breathe.",SPEED);
			print("You do this for an hour and go to bed radiating joy.",SPEED);
			print("This is what life is meant to be like.",SPEED);
			print("\n*** GOOD ENDING: Trying Things Out ***",-1);
		}
	} else {
		if (a==1){
			...
			print("The conclusion you come up with is that you are probably depressed and suicidal.",SPEED);
			...
			print("You are transgender.",SPEED);
			print("Pride surges through your chest as you see comments from other people like you.",SPEED);
			print("You decide to go online and buy some clothes to feel more like yourself.",SPEED);
			print("As you rest your eyes, you feel happy knowing the clothes will arrive in a week.",SPEED);
			print("\n*** GOOD ENDING: Transgender ***",-1);
		}
	}
	printf("%d\n\n",c);
}
